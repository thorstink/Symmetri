 ...
 * @brief Observer subscribes on Observable and obtains values provided by
 * Observable.
 ...
 * - on_completed() - succeed termination callback - observable is done, no any
 * future emissions from this
