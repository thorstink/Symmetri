...
template <rpp::constraint::subscriber T>
using extract_subscriber_type_t =
    typename details::extract_subscriber_type<T>::type;
}  // namespace rpp::utils

namespace rpp::constraint {
template <typename T, typename Type>
concept subscriber_of_type =
    subscriber<T> && std::same_as<utils::extract_subscriber_type_t<T>, Type> &&
