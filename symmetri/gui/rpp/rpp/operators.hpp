 ...
 * \brief Operators is way to modify observables and extend with some extra
 * custom logic \see https://reactivex.io/documentation/operators.html \ingroup
 * rpp
 */
 ...
 * observable \see
 * https://reactivex.io/documentation/operators.html#transforming \ingroup
 * operators
 */
 ...
 * satisfies some condition \see
 * https://reactivex.io/documentation/operators.html#filtering \ingroup
 * operators
 */
 ...
 * condition including condition of items from other observables \see
 * https://reactivex.io/documentation/operators.html#conditional \ingroup
 * operators
 */
 ...
 * observables into same observable by some rule \see
 * https://reactivex.io/documentation/operators.html#combining \ingroup
 * operators
 */
 ...
 * \brief Aggregate operators are operators on the entire sequence of items
 * provided by observable \see
 * https://reactivex.io/documentation/operators.html#mathematical \ingroup
 * operators
 */
 ...
 * without changing of original values, but changing of behaviour \see
 * https://reactivex.io/documentation/operators.html#utility \ingroup operators
 */
 ...
 * for multicasting of controlling of subscription \see
 * https://reactivex.io/documentation/operators.html#connectable \ingroup
 * operators
 */
 ...
 * \brief Error handling operators Operators that help to recover from error
 * notifications from an Observable. \see
 * https://reactivex.io/documentation/operators.html#error \ingroup operators
 */
