...
struct lambda_strategy {
  ...
  explicit lambda_strategy(TOnNext&& on_next, TOnError&& on_error,
...
auto make_lambda_observer(OnNext&& on_next, OnError&& on_error,
  ...
  return lambda_observer<Type, std::decay_t<OnNext>, std::decay_t<OnError>,
                         std::decay_t<OnCompleted>>{
...
auto make_lambda_observer(const rpp::composite_disposable_wrapper& d,
    ...
    -> lambda_observer_with_external_disposable<Type, std::decay_t<OnNext>,
                                                std::decay_t<OnError>,
                                                std::decay_t<OnCompleted>> {
  return lambda_observer_with_external_disposable<Type, std::decay_t<OnNext>,
                                                  std::decay_t<OnError>,
                                                  std::decay_t<OnCompleted>>{
