...
/**
 * \brief Creates rpp::specific_observable which emits sequence of size_t every
 ...
 *
 * \param period period which would be used to delay emissions between each
 other
 * \param scheduler used for scheduling this periodic emissions
 * \return rpp::specific_observable which emits values with provided
 time_interval
 *
 * \par Examples:
...
/**
 * \brief Creates rpp::specific_observable which emits sequence of size_t every
 provided time interval with first emission after provided delay
 *
