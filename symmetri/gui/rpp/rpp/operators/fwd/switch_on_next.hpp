...
struct member_overload<Type, SpecificObservable, switch_on_next_tag> {
  ...
  *
  * \return new specific_observable with the switch_on_next operator as most
  recent operator.
  ...
  * - <b>OnCompleted</b>
  *    - Just forwards original on_completed if no any active inner observable
  or original observable yet
  *
  ...
  */
  ...
  auto switch_on_next() const&
    requires(is_header_included<switch_on_next_tag, Args...> &&
