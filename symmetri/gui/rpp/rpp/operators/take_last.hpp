...
class take_last_observer_strategy {
 ...
 private:
  size_t get_next(size_t pos) const { return ++pos >= m_data.size() ? 0 : pos; }
 ...
 */
inline auto take_last(size_t count) { return details::take_last_t{count}; }
}  // namespace rpp::operators
