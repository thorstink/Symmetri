...
/**
 * @brief Transform the items emitted by an Observable into Observables, then
 ...
 * @details Note that flat_map merges the emissions of these Observables, so
 that they may interleave.
 *
