...
template <constraint::decayed_type Type,
          ::rpp::constraint::on_subscribe<Type> OnSubscribe,
...
template <constraint::decayed_type Type, typename DisposableStrategy,
          rpp::constraint::on_subscribe<Type> OnSubscribe>
auto create_subject_on_subscribe_observable(OnSubscribe&& on_subscribe) {
  return rpp::observable<
      Type, subject_on_subscribe_strategy<Type, std::decay_t<OnSubscribe>,
                                          DisposableStrategy>>(
