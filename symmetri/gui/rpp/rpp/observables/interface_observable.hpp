...
concept op_fn =
    constraint::observable<utils::decayed_invoke_result_t<T, TObservable>>;
}  // namespace rpp::details

namespace rpp {
/**
 * \brief Base part of observable. Mostly used to provide some interface
 * functions used by all observables \tparam Type type provided by this
 * observable \tparam SpecificObservable final type of observable inherited from
 * this observable to successfully copy/move it
 */
...
struct RPP_EMPTY_BASES interface_observable
    : public details::typed_observable_tag<Type>,
      ...
      details::member_overload<Type, SpecificObservable,
                               details::combine_latest_tag>,
      ...
      details::member_overload<Type, SpecificObservable,
                               details::distinct_until_changed_tag>,
      ...
      details::member_overload<Type, SpecificObservable,
                               details::multicast_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::observe_on_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::on_error_resume_next_tag>,
      ...
      details::member_overload<Type, SpecificObservable,
                               details::start_with_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::subscribe_on_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::subscribe_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::switch_map_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::switch_on_next_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::take_last_tag>,
      details::member_overload<Type, SpecificObservable, details::take_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::take_until_tag>,
      details::member_overload<Type, SpecificObservable,
                               details::take_while_tag>,
      ...
      details::member_overload<Type, SpecificObservable,
                               details::with_latest_from_tag> {
 public:
  /**
   * \brief The apply function to observable which returns observable of another
   * type \tparam OperatorFn type of function which applies to this observable
  ...
  /**
   * \brief Converts existing observable to rpp::blocking_observable which has
   * another interface and abilities
   */
  auto as_blocking() const& { return blocking_observable{CastThis()}; }

  auto as_blocking() && { return blocking_observable{MoveThis()}; }
